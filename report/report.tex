...
\titlespacing*{\section}{\parindent}{1.5\baselineskip}{1.2\baselineskip}
\titlespacing*{\subsection}{\parindent}{1.5\baselineskip}{39pt}  % 1.5 межстрочное расстояние для подсекций
\titlespacing*{\subsubsection}{\parindent}{\baselineskip}{0pt}  % Убираем вертикальный отступ после \subsubsection
