...
% \titlespacing*{\subsection}{0pt}{1.5\baselineskip}{1.5\baselineskip}  % 1.5 межстрочное расстояние для подсекций
\titlespacing*{\subsubsection}{0pt}{1ex}{0pt}  % Убираем вертикальный отступ после \subsubsection
